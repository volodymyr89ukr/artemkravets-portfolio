    ...
    <section id="services" className="container-shell py-20 md:py-28">
      <div className="mb-12">
        <h2 className="text-4xl md:text-5xl">
          Pricing <span className="font-body">&amp;</span> Packages
        </h2>
      </div>
        ...
        {services.map((pkg) => (
          ...
          >
            ...
            <div className="mt-6 mb-8 pb-8" style={{ borderBottom: '1px solid var(--border)' }}>
              ...
              <p className="font-display mt-1 text-4xl" style={{ color: 'var(--accent)' }}>
                {pkg.price}
              </p>
              <p className="mt-2 text-xs uppercase tracking-[0.25em]" style={{ color: 'var(--muted)' }}>
                {pkg.priceNote}
              </p>
            </div>

            {/* Includes */}
            <p className="mb-5 text-xs uppercase tracking-[0.25em]" style={{ color: 'var(--muted)' }}>
              Includes
            </p>
